  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Assessment Health Monitor</h1>
          <p className="text-muted-foreground">Comprehensive assessment quality and performance analytics</p>
        </div>
