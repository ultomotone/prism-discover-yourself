...
const CoreAlignments = () => {
  const coreAlignments = [
    ...
    },
    {
      ...
      archetype: "Hard-nosed yet principled achievers who keep their eyes on the prize. This group is all about practical results, personal responsibility, and realistic goals. Pragmatic Realists combine long-term strategy with down-to-earth execution. They are driven to turn visions into tangible outcomes, valuing efficiency, honesty, and loyalty – making things work in the real world.",
      coreValues: "Efficacy and authenticity. Pragmatic Realists prize effective action and concrete success above idle speculation – they value what works. Guided by foresight and willpower (strong Ni/Se), they focus on long-term gains and strategic thinking: this group is naturally inclined to plan ahead, anticipate future trends, and position themselves (and their allies) to capitalize on opportunities.\n\nThey demand grounded logic and proof (valuing Te): new ideas must demonstrate real-world merit or usefulness before earning their commitment. In personal ethos, they also hold integrity and trustworthiness in high regard (valuing Fi). Once a person proves their loyalty or competence, a Pragmatic Realist will reciprocate with strong loyalty in turn, forming tight alliances.\n\nHowever, their sense of ethics isn't sentimental – it's justice-oriented and merit-based. They believe each individual should pull their own weight, and they won't hesitate to hold others accountable for failing promises or betraying trust.\n\nIn this group's culture, there is a 'earn your place' mentality: respect and trust are gained through actions and reliability. They often emphasize self-improvement and accountability – continually bettering oneself and one's situation is expected, and excuses for incompetence or disloyalty wear thin quickly.",
      characteristics: "When Pragmatic Realists come together, the mood is focused, candid, and enterprising. Conversations gravitate toward practical matters – plans, business ideas, career goals, strategies for solving problems, or sharing useful life lessons. There's enjoyment in trading tips about finance, health, or skill-building – anything that can yield tangible benefit and progress.\n\nSocially, they tend to have a serious or matter-of-fact tone. They can certainly relax and enjoy friends, but even their socializing often has purpose (like networking with trusted colleagues or discussing meaningful topics one-on-one at a big party rather than mingling aimlessly). The atmosphere they prefer is no-nonsense and meritocratic: show your true self and prove your value.\n\nThey may form close-knit networks of reliable allies rather than broad, casual friend groups – quality over quantity. Outsiders or new ideas aren't rejected outright, but they must prove themselves useful or trustworthy to be welcomed into the inner circle.\n\nCompared to more idealistic groups, Pragmatic Realists come off as worldly and maybe a bit cynical – they're quick to spot flaws or scams and won't sugarcoat their critique. Yet, among those they respect, they are extremely loyal and supportive, going to great lengths to help a friend or partner achieve a mutual goal. The underlying vibe is 'we're in this together, let's get results'.",
      prismPerspective: "PRISM recognizes Pragmatic Realists as exactly that – grounded go-getters focused on results – but it also broadens their portrait by highlighting the diversity and growth potential within this group.\n\nIn classical Socionics, this group was sometimes painted as the most 'adult' or materialistic group (all about business, money, and self-interest). PRISM acknowledges that these types do excel at cutting through nonsense to achieve outcomes, but it reframes their traits in a more constructive, developmental light.\n\nIndividuals in this group are fundamentally driven by efficacy (getting things done right) and authenticity (staying true to one's values/loyalties). That drive can manifest in very positive ways – such as entrepreneurial success, championing reform in a broken system, or steadfastly supporting loved ones – or if unchecked, it can degenerate into workaholism or cynicism (e.g. becoming so focused on goals that one loses trust in others or neglects life's joys).\n\nPRISM stresses that Pragmatic Realists are not one-dimensional 'money machines.' In fact, they often care deeply about self-improvement and even community improvement – they just approach it in a practical, accountable manner. Many will spearhead personal growth initiatives or self-help programs (which sounds a bit like the Humanitarian Stabilizers' style) because they take responsibility for making life better, not just for themselves but for those they care about.\n\nImportantly, PRISM highlights that there is no single mold for a Pragmatic Realist. Two individuals of this group can look quite different. For example, one ESFp (SEE) might be a brash, hard-driving entrepreneur embodying the forceful, fast-paced side of this group's nature, while another ESFp with a gentler disposition and more patience could almost resemble a Humanitarian Stabilizer-like supportive mentor, focusing on people and long-term well-being.\n\nBoth share the same core values of productivity and loyalty, but their style and attitude vary due to personal development. PRISM openly embraces such subtype variation and 'cusp' personalities – individuals who have developed some tendencies of a neighboring group.\n\nFor instance, an ENTj (LIE) from this group who has worked to cultivate more empathy and present-moment appreciation might start to exhibit some Humanitarian Stabilizer vibes (enjoying comfort, exploring new ideas collaboratively) even though their fundamental cognitive wiring remains that of a Pragmatic Realist.\n\nRather than seeing this as contradictory, PRISM sees personality as a continuum: Pragmatic Realists can learn flexibility, patience, and forgiveness from their Humanitarian Stabilizer counterparts, just as other groups might learn realism and decisiveness from Pragmatic Realists.\n\nIn summary, PRISM keeps this group's backbone of ambition, realism, and loyalty, but enriches their definition by accounting for emotional development and context. A mature Pragmatic Realist at their best will integrate just enough openness, humor, or softness (traits not typically in their forte) to avoid becoming a ruthless caricature.\n\nAnd under stress, even these tough types might surprise you – they could momentarily retreat into the comforts of their opposite group (for example, a normally driven ENTj procrastinating with trivial cozy routines when overwhelmed, a fleeting lapse into Alpha-like indulgence).\n\nBy charting these dynamic states, PRISM presents Pragmatic Realists as real human beings who adapt, not unchanging efficiency machines. They remain results-focused realists, but with many shades and the capacity to grow, balance, and even occasionally lighten up, given the right circumstances.",
      types: [
