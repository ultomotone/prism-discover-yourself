  ...
  const coreAlignments = [
    {
      ...
      coreValues: "Openness to possibilities and intellectual playfulness. Innovative Harmonizers prize explorative thinking and brainstorming (valuing Intuition over strict Sensation), and they enjoy exchanging theories or inventive ideas for fun. They combine this with a love of personal comfort and present-moment enjoyment, making sure everyone feels at ease (a hallmark of their valued Sensing). Socially, they emphasize warmth, humor, and inclusive friendship, courtesy of valuing empathetic Feeling and principled Thinking in equal measure – debates and discussions are approached as friendly games rather than serious fights.",
      characteristics: "These types create a relaxed, merry atmosphere where hierarchy is low and everyone is welcome. Group gatherings tend to be lighthearted – filled with jokes, creative chatter, shared hobbies, and a 'family-like' inclusive spirit. Maintaining good vibes and group harmony is paramount: conflict, heavy negativity, or forceful authority displays are usually sidestepped or downplayed in favor of keeping things convivial. They are often democratic and open-minded, happy to consider multiple viewpoints (strong Ne/Si influence) as long as it keeps the environment positive and interesting. Rigid schedules or aggressive pushiness (which relate to functions they don't value) make them uncomfortable, so they prefer flexible plans and gentle encouragement over hard coercion.",
      prismPerspective: "Innovative Harmonizers still shine as curious, friendly creators, but PRISM emphasizes that they are not limited to being carefree idealists 24/7. Context can prompt these individuals to stretch beyond their usual comfort. For example, under acute stress they might tap into their opposite traits, showing uncharacteristic assertiveness or focus (a temporary shift toward more hard-driving energy). Likewise, life experience – say, an inventive entrepreneur from this quadra having to run a business – can teach an Innovative Harmonizer to 'buckle down' with practicality and structure (developing a usually unvalued trait like disciplined logic, Te). PRISM highlights these adaptations: at heart they remain improvisational, curiosity-driven harmonizers, but mature members can overcome their conflict-aversion and lack of focus when needed. In essence, PRISM retains this quadra's core of creativity, flexibility, and conviviality, while showing that they can integrate realism and assertiveness as personal growth calls for it. An Innovative Harmonizer at their best still brings people together in positive, idea-rich environments, yet also knows how to get serious to reach goals when the situation demands – they evolve from simply 'fun-loving' into capable of blending imagination with a bit of discipline for greater impact.",
      types: [
    ...
    },
    {
      ...
      coreValues: "Efficacy and authenticity. Pragmatic Realists prize effective action and concrete success above idle speculation – they value what works. Guided by foresight and willpower (strong Ni/Se), they focus on long-term gains and strategic thinking: this group is naturally inclined to plan ahead, anticipate future trends, and position themselves (and their allies) to capitalize on opportunities. They demand grounded logic and proof (valuing Te): new ideas must demonstrate real-world merit or usefulness before earning their commitment. In personal ethos, they also hold integrity and trustworthiness in high regard (valuing Fi). Once a person proves their loyalty or competence, a Pragmatic Realist will reciprocate with strong loyalty in turn, forming tight alliances. However, their sense of ethics isn't sentimental – it's justice-oriented and merit-based. They believe each individual should pull their own weight, and they won't hesitate to hold others accountable for failing promises or betraying trust. In this quadra's culture, there is a 'earn your place' mentality: respect and trust are gained through actions and reliability. They often emphasize self-improvement and accountability – continually bettering oneself and one's situation is expected, and excuses for incompetence or disloyalty wear thin quickly.",
      characteristics: "When Pragmatic Realists come together, the mood is focused, candid, and enterprising. Conversations gravitate toward practical matters – plans, business ideas, career goals, strategies for solving problems, or sharing useful life lessons. There's enjoyment in trading tips about finance, health, or skill-building – anything that can yield tangible benefit and progress. Socially, they tend to have a serious or matter-of-fact tone. They can certainly relax and enjoy friends, but even their socializing often has purpose (like networking with trusted colleagues or discussing meaningful topics one-on-one at a big party rather than mingling aimlessly). The atmosphere they prefer is no-nonsense and meritocratic: show your true self and prove your value. They may form close-knit networks of reliable allies rather than broad, casual friend groups – quality over quantity. Outsiders or new ideas aren't rejected outright, but they must prove themselves useful or trustworthy to be welcomed into the inner circle. Compared to more idealistic quadras, Pragmatic Realists come off as worldly and maybe a bit cynical – they're quick to spot flaws or scams and won't sugarcoat their critique. Yet, among those they respect, they are extremely loyal and supportive, going to great lengths to help a friend or partner achieve a mutual goal. The underlying vibe is 'we're in this together, let's get results'.",
      prismPerspective: "PRISM recognizes Pragmatic Realists as exactly that – grounded go-getters focused on results – but it also broadens their portrait by highlighting the diversity and growth potential within this group. In classical Socionics, Gamma quadra was sometimes painted as the most 'adult' or materialistic group (all about business, money, and self-interest). PRISM acknowledges that these types do excel at cutting through nonsense to achieve outcomes, but it reframes Gamma traits in a more constructive, developmental light. Individuals in this quadra are fundamentally driven by efficacy (getting things done right) and authenticity (staying true to one's values/loyalties). That drive can manifest in very positive ways – such as entrepreneurial success, championing reform in a broken system, or steadfastly supporting loved ones – or if unchecked, it can degenerate into workaholism or cynicism (e.g. becoming so focused on goals that one loses trust in others or neglects life's joys). PRISM stresses that Pragmatic Realists are not one-dimensional 'money machines.' In fact, they often care deeply about self-improvement and even community improvement – they just approach it in a practical, accountable manner. Many will spearhead personal growth initiatives or self-help programs (which sounds a bit like Delta quadra's style) because they take responsibility for making life better, not just for themselves but for those they care about. Importantly, PRISM highlights that there is no single mold for a Pragmatic Realist. Two individuals of this quadra can look quite different. For example, one ESFp (SEE) might be a brash, hard-driving entrepreneur embodying the forceful, fast-paced side of this group's nature, while another ESFp with a gentler disposition and more patience could almost resemble a Delta-like supportive mentor, focusing on people and long-term well-being. Both share the same core Gamma values of productivity and loyalty, but their style and attitude vary due to personal development. PRISM openly embraces such subtype variation and 'cusp' personalities – individuals who have developed some tendencies of a neighboring quadra. For instance, an ENTj (LIE) from this quadra who has worked to cultivate more empathy and present-moment appreciation might start to exhibit some Delta quadra vibes (enjoying comfort, exploring new ideas collaboratively) even though their fundamental cognitive wiring remains Gamma. Rather than seeing this as contradictory, PRISM sees personality as a continuum: Pragmatic Realists can learn flexibility, patience, and forgiveness from their Delta counterparts, just as other quadras might learn realism and decisiveness from Pragmatic Realists. In summary, PRISM keeps this quadra's backbone of ambition, realism, and loyalty, but enriches their definition by accounting for emotional development and context. A mature Pragmatic Realist at their best will integrate just enough openness, humor, or softness (traits not typically in their forte) to avoid becoming a ruthless caricature. And under stress, even these tough types might surprise you – they could momentarily retreat into the comforts of their opposite quadra (for example, a normally driven ENTj procrastinating with trivial cozy routines when overwhelmed, a fleeting lapse into Alpha/Delta-like indulgence). By charting these dynamic states, PRISM presents Pragmatic Realists as real human beings who adapt, not unchanging efficiency machines. They remain results-focused realists, but with many shades and the capacity to grow, balance, and even occasionally lighten up, given the right circumstances.",
      types: [
    ...
    },
    {
      ...
      coreValues: "Steady improvement and ethical sincerity. Humanitarian Stabilizers value doing what's right and what works in the long run. They emphasize integrity, trust, and personal values (valuing Fi strongly) – decisions must feel morally sound and considerate of others' well-being. At the same time, they prize usefulness and competence (valuing Te): they want their work and relationships to actually improve life in tangible ways. This combination yields a highly conscientious outlook: they tend to be diligent, reliable, and oriented toward sustainable results that align with their principles. Additionally, they share the Ne/Si intuitive-sensing pairing with the Alpha group, which means they appreciate openness to possibilities and ideas (Ne) balanced with comfort, stability, and practicality (Si). In simple terms, they are open-minded but not reckless – willing to explore new approaches if it seems useful and humane, and patient enough to implement changes gradually.",
      characteristics: "Among a group of Humanitarian Stabilizers, you'll notice a low-pressure, cooperative atmosphere. These types generally eschew harshness or aggression – they aren't fond of high-conflict, competitive environments (they have weak tolerance for domineering Se force). Instead, they foster a sense of egalitarian friendship: everyone's input is respected, and decisions might be made through calm discussion and consensus. There's often a modest, no-frills quality to their gatherings – they can be warm and friendly, but not flashy or hyper-intense. Think of a close-knit club or a community volunteer group where people quietly help each other improve; that's the Delta spirit. They are serious about their commitments and values, yet relaxed in interpersonal style – preferring encouragement over command, and personal authenticity over strict protocol. In teams, they often emerge as the supportive backbone: the colleague who makes sure everyone is heard and the project stays on track ethically, or the friend who organizes get-togethers and gently includes the shy newcomer. They may not seek the spotlight, but they excel at creating supportive, stable environments where people can flourish. Outsiders might sometimes perceive them as 'boring' or overly nice, especially compared to the flashier, high-energy quadras. However, this underrates their quiet strength. These individuals often have a reservoir of patience, resilience, and resourcefulness that keeps groups and projects going when others would burn out. They also have their own kind of creativity: a gentle ingenuity that introduces novel ideas or improvements in a way that everyone can get on board with (subtle Ne at work).",
      prismPerspective: "PRISM views Humanitarian Stabilizers as 'ethical caretakers' and steady builders – the folks who keep things running and growing in a humane way. While Socionics' traditional take sometimes labels this quadra as the most modest and low-key (the people who are good-natured but can fade into the background), PRISM challenges the stereotype that they are simplistic or unambitious. It highlights the quiet versatility and adaptability of these types. For instance, even a usually calm, methodical ESTj (LSE) in this group can step up with surprising assertiveness in a crisis, tapping into an unvalued aggressive streak (Se) when urgency calls for it. Likewise, an ENFp (IEE) who is normally gentle might momentarily don a charismatic, rally-the-troops persona (more typical of Beta quadra) to unite others around an important value or cause. PRISM underscores that these folks are not 'just passive helpers.' They often take initiative in their own style – becoming mentors, guides, or quiet influencers who spark change without needing loud fanfare. They introduce new ideas (thanks to their Ne openness) in approachable, inclusive ways, proving that one can be innovative and stable at the same time. Another key nuance PRISM adds is recognizing the range of personalities within this quadra. Humanitarian Stabilizers aren't all cookie-cutter do-gooders. One INFj (EII) in this quadra might indeed be very traditional, reserved, and cautious, while another INFj with a more adventurous streak or an 'extroverted' subtype could be more outgoing and experimental – almost Alpha-like in their playful curiosity. Both would still be recognizably Delta in their core values (seeking sincerity, usefulness, and comfort for all), but their life experiences and traits produce different flavors of the same theme. This aligns with PRISM's goal of avoiding one-size-fits-all labels; even the most cooperative, modest Stabilizer might have a rebellious or ambitious streak hiding in them. In fact, PRISM points out that Deltas and Gammas (Humanitarian Stabilizers and Pragmatic Realists) have more in common than one might think – they share the same Te/Fi value pairing for productivity and ethics, differing primarily in tempo and focus. Gammas push for big results now with a fast, decisive tempo, whereas Deltas favor gradual growth and personal well-being, moving at a patient pace. Understanding this continuum allows PRISM to guide individuals in learning from each other: a Stabilizer can borrow a page from the Realist's book to be more decisive when opportunity knocks, and a Realist can learn from the Stabilizer's patience and people-focus for long-term teamwork. Overall, PRISM retains this quadra's image as ethical, growth-oriented facilitators, but gives them credit for a complexity that earlier models might have overlooked. These 'quiet optimists' blend imagination with realism – they believe in a better future but also handle the practical steps to get there – and with time and support, they prove adept at achieving enduring positive change in their communities. Rather than being boring do-gooders, they emerge as the steady innovators, ensuring that lofty ideas (theirs or others') take root and flourish in reality.",
      types: [
