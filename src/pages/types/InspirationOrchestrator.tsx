              ...
              <section>
                ...
                <div className="prism-card p-6">
                  <p className="text-lg leading-relaxed mb-4">
                    EIEs are passionate visionaries powered by extroverted feeling (Fe) base and introverted intuition (Ni) creative. Their Fe base is 4-dimensional and high-intensity – EIEs live and breathe the emotional currents of human interaction. They are adept at inspiring others, conveying sentiments dramatically, and rallying people around ideas or causes. With a "plus" Fe, they tap into a wide spectrum of emotional expression, often amplifying the mood to create momentum or urgency. They aren't afraid of strong feelings; in fact, they believe that a surge of enthusiasm, outrage, or joy can be the catalyst for meaningful change.
                  </p>
                  <p className="text-lg leading-relaxed mb-4">
                    Paired with this is Ni creative, which gives them a strategic, if sometimes cautionary, sense of timing and destiny. EIEs use Ni to weave narratives about where things are headed – their intuition often focuses on the grand arc of events, cultural movements, or an individual's potential path (with a "minus" tilt, meaning they're sensitive to what could go wrong or what challenges lie ahead).
                  </p>
