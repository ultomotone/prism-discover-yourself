      ...
      <div className="max-w-6xl mx-auto">
          ...
          <section className="mb-12" aria-label="Recommended starting point">
            <div className="mb-6 text-center">
              ...
              <p className="text-muted-foreground">Not sure which service fits your organization? Start here for expert guidance.</p>
            </div>
            {(() => {
              const discoveryService = organizationServices.find(s => s.key === 'owner-leader-discovery');
