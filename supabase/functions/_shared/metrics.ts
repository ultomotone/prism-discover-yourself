...
// Simple console-based logger for edge functions
const logger = {
  info: (event: string, data: any) => console.log(JSON.stringify({ level: "info", event, ...data })),
  error: (event: string, data: any) => console.log(JSON.stringify({ level: "error", event, ...data })),
};
