...
-- Create robust v1.1 views with safe division and proper data handling

-- 1. Create/replace the v1.1 latest-assessments view with consistent numeric fits
...
-- 2. Create KPI overview view with safe division and proper bounds
...
-- 3. Grant proper access for anonymous dashboard reads
