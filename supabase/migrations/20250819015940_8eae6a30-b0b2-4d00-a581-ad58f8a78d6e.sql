-- Ensure enum has the META label used by this seed
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1
    FROM pg_enum
    WHERE enumlabel = 'META'
      AND enumtypid = 'assessment_scale_type'::regtype
  ) THEN
    ALTER TYPE assessment_scale_type ADD VALUE 'META';
  END IF;
END
$$;
...
(133, 'select-all', NULL, false, NULL, false, NULL, 0),
(134, 'ranking', NULL, false, NULL, false, NULL, 0),
