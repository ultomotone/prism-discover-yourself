-- Fix RPC ambiguity: qualify parameter references with function name
...
-- Optional performance index for token validation
CREATE INDEX IF NOT EXISTS idx_assessment_sessions_id_share_token 
