...
DROP POLICY IF EXISTS "Type prototypes are publicly readable" ON public.type_prototypes;
CREATE POLICY "Type prototypes are publicly readable"
ON public.type_prototypes
FOR SELECT
USING (true);

DROP POLICY IF EXISTS "Service role can manage type prototypes" ON public.type_prototypes;
CREATE POLICY "Service role can manage type prototypes"
ON public.type_prototypes
FOR ALL
