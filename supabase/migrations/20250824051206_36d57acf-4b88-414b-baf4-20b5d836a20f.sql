-- Drop the existing view and recreate with proper structure
DROP VIEW IF EXISTS v_activity_country_30d;
...
-- Create the new country activity view with proper ISO-2 codes
CREATE VIEW v_activity_country_30d AS
SELECT 
