-- Drop and recreate the function with correct fit score extraction
DROP FUNCTION IF EXISTS public.get_recent_assessments_safe();

-- Create the updated function with correct fit score extraction from type_scores
...
BEGIN
  ...
  SELECT 
    ...
    -- Get fit score from type_scores using the top type as key
    CASE 
