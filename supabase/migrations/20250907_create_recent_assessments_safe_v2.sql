-- 20250907_create_recent_assessments_safe_v2.sql
-- up
...
GRANT SELECT ON public.v_recent_assessments_safe_v2 TO anon;
GRANT SELECT ON public.v_recent_assessments_safe_v2 TO authenticated;
