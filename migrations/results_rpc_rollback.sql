-- Rollback: Restore original function definition (with ambiguity bug)
...
-- Remove performance index if it was created
DROP INDEX IF EXISTS public.idx_assessment_sessions_id_share_token;